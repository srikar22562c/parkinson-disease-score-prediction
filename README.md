...
The model is designed, trained, and evaluated following a complete deep learning pipeline including data preprocessing, architecture selection using validation performance, learning rate scheduling, and test-set evaluation.
